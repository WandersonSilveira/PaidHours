...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "PAID_HOURS_DB13";
    ...
    private static final String CREATE_TABLE_ALUNO = ("CREATE TABLE ALUNO(ALUNO_CODIGO INTEGER PRIMARY KEY AUTOINCREMENT, ALUNO_NOME TEXT NOT NULL, ALUNO_MATRICULA LONG NOT NULL UNIQUE, ALUNO_IMAGEM BLOB, ALUNO_STATUS BOOLEAN NOT NULL, ALUNO_CURSO_FK_CODIGO INTEGER NOT NULL );");
