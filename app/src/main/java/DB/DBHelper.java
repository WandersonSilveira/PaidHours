...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "PAID_HOURS_DB11";
    ...
    private static final String CREATE_TABLE_ALUNO = ("CREATE TABLE ALUNO(ALUNO_CODIGO INTEGER PRIMARY KEY AUTOINCREMENT, ALUNO_NOME TEXT NOT NULL, ALUNO_MATRICULA INTEGER NOT NULL UNIQUE, ALUNO_IMAGEM BLOB, ALUNO_STATUS BOOLEAN NOT NULL, ALUNO_CURSO_FK_CODIGO INTEGER NOT NULL );");
    private static final String CREATE_TABLE_CERTIFICADO = ("CREATE TABLE CERTIFICADO(CERTIFICADO_CODIGO INTEGER PRIMARY KEY AUTOINCREMENT, CERTIFICADO_NOME TEXT NOT NULL, CERTIFICADO_CARGA_HORARIA INTEGER NOT NULL, CERTIFICADO_DESCRICAO TEXT NOT NULL UNIQUE, CERTIFICADO_IMAGEM BLOB, CERTIFICADO_STATUS BOOLEAN NOT NULL, CERTIFICADO_ALUNO_FK_CODIGO INTEGER NOT NULL );");
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(CREATE_TABLE_CERTIFICADO);
    }
